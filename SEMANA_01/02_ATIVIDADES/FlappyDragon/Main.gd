...
var vscore = 0 #aumenta a pontuação do dragão quando ele passa pelas paredes
var x = 3.5 #movimenta o dragão mais rápido
var y = 1.5 #velocidade do dragão na vertical 
